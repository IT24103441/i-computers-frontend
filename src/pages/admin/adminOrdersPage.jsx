...
export default function AdminOrdersPage({ isDarkMode = false }) {
                                ...
                                {filteredOrders.map((order) => {
                                    return (
                                        <tr className={`transition-colors ${isDarkMode ? 'hover:bg-slate-800/40' : 'hover:bg-gray-50/50'
                                            ...
                                            {/* Customer */}
                                            <td className="p-4">
                                                <p className={`font-semibold text-xs ${isDarkMode ? 'text-slate-100' : 'text-gray-900'}`}>{order.firstName} {order.lastName}</p>
                                                <p className={`text-[11px] ${isDarkMode ? 'text-slate-400' : 'text-gray-400'}`}>{order.email}</p>
                                            </td>

                                            {/* City / Phone */}
                                            <td className="p-4 text-xs">
                                                <p className={`font-medium ${isDarkMode ? 'text-slate-200' : 'text-gray-800'}`}>{order.city}</p>
                                                <p className={`text-[11px] font-mono ${isDarkMode ? 'text-slate-400' : 'text-gray-400'}`}>{order.phone}</p>
                                            </td>
                                            ...
                                            <td className="p-4">
                                                    ...
                                                    className={`px-2.5 py-1.5 rounded-xl text-xs font-bold border outline-none transition-all ${order.status === "Cancelled"
                                                            ...
                                                            : order.status === "Delivered"
                                                                ...
                                                                : order.status === "Shipped"
                                                                    ? isDarkMode ? "bg-purple-500/10 text-purple-400 border-purple-500/30 hover:bg-purple-500/20 cursor-pointer" : "bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100 cursor-pointer"
                                                ...
                                                >
                                                    ...
                                                    <option value="Shipped" className={isDarkMode ? "bg-slate-900 text-white" : "bg-white text-gray-800"}>Shipped</option>
                                                    <option value="Delivered" className={isDarkMode ? "bg-slate-900 text-white" : "bg-white text-gray-800"}>Delivered</option>
                                                    <option value="Cancelled" className={isDarkMode ? "bg-slate-900 text-white" : "bg-white text-gray-800"}>Cancelled</option>
                                                </select>
                                            </td>
                                            ...
                                            {/* Total */}
                                            <td className="p-4 font-extrabold text-amber-500 text-sm">
                                            ...
                                            <td className="p-4 text-center">
                                                <div className="flex justify-center items-center gap-2">
                                                    <AdminOrderDataModal isAdmin={true} order={order} refresh={triggerRefresh} isDarkMode={isDarkMode} />
                                                </div>
                                            </td>
                                        </tr>
                                    );
